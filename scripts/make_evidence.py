...
GATES: tuple[Gate, ...] = (
    ...
    Gate("audit-runtime-hook-ratchet", "audit-runtime-hook-ratchet",
         ...
         "gating"),
    Gate("audit-dispatcher-migration-readiness", "audit-dispatcher-migration-readiness",
         "v11.3.0 P3.4: dispatcher iter_patch_specs() readiness — 0 real gaps required (--strict)",
         "gating"),
    Gate("audit-stale-vllm-version-ranges", "audit-stale-vllm-version-ranges",
         "v11.3.0 CLAUDE.md Class 5: 0 CRITICAL stale vllm_version_range upper bounds (--strict)",
         "gating"),
    Gate("audit-legacy-vs-spec-driven-apply-matrix", "audit-legacy-vs-spec-driven-apply-matrix",
         "v11.3.0 P3.4: legacy vs spec-driven apply-matrix structural comparison (informational)",
         "informational"),
    ...
    Gate("audit-source-refs-in-docs", "audit-source-refs-in-docs",
         ...
         "gating"),
    Gate("audit-docs-refs-in-source", "audit-docs-refs-in-source",
         "Phase 10.5 D-extension — Python source `docs/<name>.md` token resolution (reverse direction)",
         "gating"),
    Gate("audit-phase3-relocation", "audit-phase3-relocation",
         "§0.5 — gemma4 relocation invariants (R1 shim boundary, R2 canonical apply, R3 config-keys, R4 no launchers)",
         "gating"),
    Gate("audit-anchor-fragility", "audit-anchor-fragility",
         "Phase 3.1 — TextPatcher anchor LOC fragility ratchet (informational; warn at >=25 lines)",
         "informational"),
    Gate("audit-pn59-cliff2b", "audit-pn59-cliff2b",
         "PN59 v7.72.5 Level 2 markers — Cliff 2b chunked-prefill OOM regression guard (club-3090 #22 fix)",
         "gating"),
    Gate("audit-lifecycle-docstring-sync", "audit-lifecycle-docstring-sync",
         "Registry `lifecycle` vs docstring RETIRED/TOMBSTONED markers (PN108-class drift)",
         "gating"),
    Gate("audit-v2-runtime-pins", "audit-v2-runtime-pins",
         "§4.2 V2 runtime + ModelDef pin harmonization (R-PIN-1..R-PIN-4)",
         "gating"),
    Gate("audit-v2-modeldef-vs-hardware-pin", "audit-v2-modeldef-vs-hardware-pin",
         "Phase 5.2.E — V2 ModelDef vs hardware canonical-pin drift (F-Q7B class)",
         "gating"),
    Gate("audit-v1-sunset", "audit-v1-sunset",
         "§9.T — V1 monolithic sunset countdown (5-stage retirement; today all stages READY post-Phase 10)",
         "informational"),
    Gate("audit-english-only", "audit-english-only",
         "CLAUDE.md global rule — in-code language English-only (comments, docstrings, error messages, log strings)",
         "informational"),
    Gate("audit-private-namespace", "audit-private-namespace",
         "M.7 — vllm/**/sndr_private forbidden + wheel-boundary invariant + top-level sndr_private/ stays gitignored",
         "gating"),
    Gate("audit-shim-window", "audit-shim-window",
         "Shim retention policy — back-compat shims must self-document expiry pin or removal commit",
         "gating"),
    Gate("audit-wheel-contents", "audit-wheel-contents",
         "§9.A.1 — wheel-boundary CLI surface (pyproject shape + canonical test-file presence)",
         "gating"),
    Gate("audit-yaml-status-enum", "audit-yaml-status-enum",
         "V2 YAML status enum validation — only canonical values shipped under builtin/",
         "gating"),
    Gate("audit-override-policy", "audit-override-policy-strict",
         "Sizing override policy class — strict mode (bench evidence required for override_policy.class >= bench)",
         "gating"),
