...
def test_wasserstein_1d_identical_distributions():
    ...
    from tests.legacy.numerical_regression_helpers import wasserstein_1d
...
def test_wasserstein_per_row_identical():
    ...
    from tests.legacy.numerical_regression_helpers import wasserstein_per_row
    a = torch.randn(8, 64)
...
def test_regression_report_passes_on_identical():
    ...
    from tests.legacy.numerical_regression_helpers import regression_report
...
def test_assert_close_passes_silently():
    ...
    from tests.legacy.numerical_regression_helpers import (
...
def test_find_drift_rows_localizes_drift():
    ...
    from tests.legacy.numerical_regression_helpers import find_drift_rows
    torch.manual_seed(0)
    a = torch.randn(8, 64)
    b = a.clone()
    # Drift rows 2 and 5
