...
# P64 was consolidated 2026-06-20 into p64_p61c_pn56_qwen3coder_consolidated
# (one module absorbing P64 + P61c + PN56, each patching the qwen3_coder parser
# at disjoint regions). This legacy A-06/A-07/A-17 design-intent gate inspects
# the OLD standalone p64_qwen3coder_mtp_streaming module's docstring/comment
# shape, which no longer exists as a separate file. The intent is now carried by
# the consolidated module + its own tests (test_p61c_*, test_pn56_*, the
# tool_parsing family contract). Skipped pending migration of these assertions.
pytestmark = pytest.mark.skip(
    reason="P64 consolidated 2026-06-20; legacy design-intent gate superseded "
    "by the consolidated module's own tests"
)
