    ...
    def test_registry_has_required_fields(self):
        ...
        for stub in ["vllm", "sndr"]:
            if stub not in sys.modules:
                ...
                # Give the stub a valid __spec__ so that if it outlives this
                # test, a later importlib.util.find_spec(stub) does not raise
                # "ModuleSpec is None" and pollute other suites.
                mod.__spec__ = importlib.machinery.ModuleSpec(stub, loader=None)
