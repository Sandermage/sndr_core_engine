...
"""TDD tests for sndr.engines.vllm.kernels_legacy.tq_continuation_prefill (Patch 20).
...
def _clear_cache():
    ...
    from sndr.engines.vllm.kernels_legacy.tq_continuation_prefill import clear_pi_half_cache
    clear_pi_half_cache()
    yield
    clear_pi_half_cache()
...
class TestGetPiHalf:
    ...
    def test_fp32_gets_downcasted(self):
        from sndr.engines.vllm.kernels_legacy.tq_continuation_prefill import get_pi_half
...
class TestContinuationPrefillFp16Rotate:
    ...
    def test_shape_matches_upstream_expectation(self):
        from sndr.engines.vllm.kernels_legacy.tq_continuation_prefill import (
...
class TestGetCacheInfo:
    ...
    def test_empty_cache_reports_zero(self):
        from sndr.engines.vllm.kernels_legacy.tq_continuation_prefill import get_cache_info
