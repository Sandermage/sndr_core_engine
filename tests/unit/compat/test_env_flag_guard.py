...
def test_levenshtein_distance():
    from vllm.sndr_core.compat.env_flag_guard import _levenshtein
...
def test_collect_known_flags_includes_pn55():
    from vllm.sndr_core.compat.env_flag_guard import collect_known_flags
...
def test_no_typos_on_clean_environ():
    from vllm.sndr_core.compat.env_flag_guard import find_typos
...
def test_assert_no_typos_default_warn(caplog):
    from vllm.sndr_core.compat.env_flag_guard import assert_no_typos
    import logging
