...
class TestSectionWsl:
    def test_returns_dict_with_required_keys(self):
        from vllm.sndr_core.compat.doctor import _section_wsl
        out = _section_wsl()
...
class TestSectionImage:
    def test_skipped_without_container_env(self, monkeypatch):
        ...
        from vllm.sndr_core.compat.doctor import _section_image
        out = _section_image()
...
class TestSectionMounts:
    def test_returns_dict(self):
        from vllm.sndr_core.compat.doctor import _section_mounts
        out = _section_mounts()
...
class TestSectionLicense:
    def test_returns_required_keys(self):
        from vllm.sndr_core.compat.doctor import _section_license
...
class TestSectionEngine:
    def test_returns_required_keys(self):
        from vllm.sndr_core.compat.doctor import _section_engine
        out = _section_engine()
...
class TestSectionRemote:
    def test_returns_required_keys(self):
        from vllm.sndr_core.compat.doctor import _section_remote_capability
...
class TestCliFlags:
    def test_full_flag_in_argparse(self, capsys):
        ...
        from vllm.sndr_core.compat import doctor as D
