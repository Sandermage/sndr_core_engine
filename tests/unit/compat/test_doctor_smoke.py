...
"""Smoke tests for vllm.sndr_core.compat.doctor.
...
def test_format_text_produces_lines():
    from vllm.sndr_core.compat.doctor import _format_text, collect_report
    report = collect_report()
...
def test_main_returns_int():
    from vllm.sndr_core.compat.doctor import main
    rc = main(argv=["--quiet"])
...
def test_environment_section_shape():
    ...
    from vllm.sndr_core.compat.doctor import _section_environment
