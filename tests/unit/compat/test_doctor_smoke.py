...
"""Smoke tests for sndr.compat.doctor.
...
def test_format_text_produces_lines():
    from sndr.compat.doctor import _format_text, collect_report
    report = collect_report()
...
def test_main_returns_int():
    from sndr.compat.doctor import main
    rc = main(argv=["--quiet"])
...
def test_environment_section_shape():
    ...
    from sndr.compat.doctor import _section_environment
