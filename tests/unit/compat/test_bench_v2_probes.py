...
def bench_module():
    ...
    # Wave 12+ (2026-06-01) canonical location. The legacy
    # vllm/sndr_core/tools/ path was removed from the wheel; the shipped
    # module now lives under sndr/extras/tools/.
    bench_path = (
