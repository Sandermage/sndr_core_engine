...
"""Tests for vllm.sndr_core.compat.recipes — `genesis recipe` system.
...
class TestStorage:
    def test_save_creates_file(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import save
    ...
    def test_save_then_load_roundtrip(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import save, load
    ...
    def test_load_unknown_returns_None(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import load
        result = load("does-not-exist")
        assert result is None

    def test_list_names_empty(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import list_names
        assert list_names() == []

    def test_list_names_after_save(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import save, list_names
    ...
    def test_delete_removes_file(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import save, delete, list_names
    ...
    def test_delete_unknown_returns_false(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import delete
...
class TestValidate:
    def test_valid_recipe_passes(self):
        from vllm.sndr_core.compat.recipes import validate_recipe
...
class TestToLaunchScript:
    def test_generate_bash_string(self, tmp_recipes_dir):
        from vllm.sndr_core.compat.recipes import to_launch_script
...
class TestCLI:
    ...
    def test_save_then_list(self, tmp_recipes_dir, capsys):
        from vllm.sndr_core.compat.recipes import save, main
    ...
    def test_delete_subcommand(self, tmp_recipes_dir, capsys):
        from vllm.sndr_core.compat.recipes import save, list_names, main
        save("doomed", _VALID_RECIPE)
...
class TestDiffRecipes:
    ...
    def test_diff_identical_recipes_is_empty(self):
        from vllm.sndr_core.compat.recipes import diff_recipes
