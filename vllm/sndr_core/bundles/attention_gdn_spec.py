...
def apply() -> tuple[str, str]:
    ...
    from vllm.sndr_core.integrations.attention.gdn import p60_gdn_ngram_state_recovery as _p60

    from vllm.sndr_core.integrations.attention.gdn import p60b_gdn_ngram_triton_kernel as _p60b
    return run_bundle(
