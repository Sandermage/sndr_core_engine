...
def apply() -> tuple[str, str]:
    ...
    from vllm.sndr_core.integrations.attention.turboquant import p67_tq_multi_query_kernel as _p67

    from vllm.sndr_core.integrations.attention.turboquant import p67b_spec_verify_routing as _p67b
    return run_bundle(
