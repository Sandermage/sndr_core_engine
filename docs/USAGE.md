...
> Genesis `v12.0.0` (241 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 241 small surgical
...
The patch registry is the heart of Genesis. 241 entries live in
