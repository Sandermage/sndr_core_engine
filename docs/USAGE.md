...
> Genesis `v12.0.0` (308 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 308 small surgical
...
The patch registry is the heart of Genesis. 308 entries live in
