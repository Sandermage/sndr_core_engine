...
> Genesis `v12.0.0` (287 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 287 small surgical
...
The patch registry is the heart of Genesis. 287 entries live in
