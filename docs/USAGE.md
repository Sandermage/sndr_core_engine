...
> Genesis `v12.0.0` (315 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 315 small surgical
...
The patch registry is the heart of Genesis. 315 entries live in
