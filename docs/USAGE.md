...
> Genesis `v12.0.0` (276 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 276 small surgical
...
The patch registry is the heart of Genesis. 276 entries live in
