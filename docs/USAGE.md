...
> Genesis `v12.0.0` (254 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 254 small surgical
...
The patch registry is the heart of Genesis. 254 entries live in
