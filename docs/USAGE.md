...
> Genesis `v12.0.0` (320 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 320 small surgical
...
The patch registry is the heart of Genesis. 320 entries live in
