...
> Genesis `v12.0.0` (238 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 238 small surgical
...
The patch registry is the heart of Genesis. 238 entries live in
