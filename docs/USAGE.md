...
> Genesis `v12.0.0` (317 PATCH_REGISTRY entries) ·
...
`vllm.general_plugins` entry point and applies 317 small surgical
...
The patch registry is the heart of Genesis. 317 entries live in
