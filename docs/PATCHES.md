...
**Total PATCH_REGISTRY entries:** 308 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **308** |
...
| Implementation status=full | 248 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 286 / 308 = 92.9% |
