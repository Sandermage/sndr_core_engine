...
**Total PATCH_REGISTRY entries:** 315 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **315** |
...
| Implementation status=full | 256 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 6 + 6) |
| Apply-loop coverage (apply_module set) | 293 / 315 = 93.0% |
