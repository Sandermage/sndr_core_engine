...
**Total PATCH_REGISTRY entries:** 303 — range covers `P1`–`P109` legacy +
`PN8`–`PN388` modern + `G4_01`–`G4_81` Gemma 4 family + sub-patches
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **303** |
| Tier=community (Apache 2.0, sndr) | **302** (all entries) |
...
| Implementation status=full | 243 |
| Implementation status=marker_only / placeholder / partial / retired | 34 (20 + 2 + 8 + 4) |
| Apply-loop coverage (apply_module set) | 281 / 303 = 92.7% |
