...
**Total PATCH_REGISTRY entries:** 324 — range covers `P1`–`P109` legacy +
...
| Metric | Count |
|:-------|:------|
| Total PATCH_REGISTRY entries | **324** |
...
| Implementation status=full | 262 |
| Implementation status=marker_only / placeholder / partial / retired | 37 (22 + 2 + 7 + 6) |
| Apply-loop coverage (apply_module set) | 300 / 324 = 92.6% |
