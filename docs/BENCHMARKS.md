...
>
> - Genesis `v11.0.0+wave10` — 226 PATCH_REGISTRY entries
...
# Boot vLLM via the unified launcher (Wave 10 canonical):
...
- `tools/multi_conc_bench.py` — Wave 10 multi-concurrency sweep
