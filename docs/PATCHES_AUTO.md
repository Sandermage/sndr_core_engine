...
Generated: 2026-07-02T23:47:26Z
Total entries: **324**
...
### Default-on at boot: **57** / 324

### By family
- `attention`: 2
- `attention.flash`: 3
- `attention.gdn`: 34
- `attention.turboquant`: 64
- `compile_safety`: 17
- `detection`: 3
- `gemma4`: 20
- `kernels`: 9
...
| **PN521** | `community` | `experimental` | · | `GENESIS_ENABLE_PN521_TQ_RAW_TAIL_VERIFY` | — | TurboQuant raw-bf16-tail spec-verify — fix INT4 non-pow2-GQA (Qwen3.6-27B Aut... |
...
| **PN521_SPLIT_K** | `community` | `experimental` | · | `GENESIS_ENABLE_PN521_SPLIT_K` | — | PN521 split-K (Flash-Decoding) occupancy fix for the raw-tail verify — ~11x f... |
...
| **PN522** | `community` | `experimental` | · | `GENESIS_ENABLE_PN522_TQ_RAW_TAIL_WARMUP` | — | PN521 raw-tail kernel pre-capture warmup — remove the first-request JIT laten... |
