...
#### 3. Genesis patch lock-in (160 runtime patches in PATCH_REGISTRY, ~38 active on 27B PROD / ~31 active on 35B PROD)
Genesis maintains 160 vLLM runtime patches in PATCH_REGISTRY (audit 2026-05-11). Active subset varies per-model:
