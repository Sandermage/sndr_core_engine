...
export function PresetRecommendPanel({
  ...
  return (
    <div className="preset-recommend">
      <div className="rec-workloads" role="group" aria-label="Workload">
          ...
          {result.results.length > 0 ? (
            <div className="patch-table-scroll">
              <table className="module-table rec-table">
                <thead><tr><th scope="col">#</th><th scope="col">Preset</th><th scope="col">Model</th><th scope="col">Hardware</th><th scope="col">Profile</th><th scope="col">Baseline</th><th scope="col" aria-label="Actions" /></tr></thead>
                <tbody>
